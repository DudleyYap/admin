<?php 
    ...
    $query = "SELECT * FROM u_boss_payment WHERE u_boss_payment.id = '$id'";
    ...
    //Management fee
    $details_query = "SELECT MONTHNAME(received_date) AS month_name,u_bp_maintenance.* FROM u_bp_maintenance WHERE acc_id = '$acc_id' AND YEAR(payment_date) = '$year_select' ORDER BY received_date";
    ...
    //Water bill
    $wb_query = "SELECT MONTHNAME(payment_date) AS month_name, u_management_water_bill.* FROM u_management_water_bill WHERE acc_id = '$acc_id' AND YEAR(payment_date) = '$year_select' ORDER BY received_date";
    ...
    //Sinking Fund
    $li_query = "SELECT MONTHNAME(payment_due_date) AS month_name, u_boss_sinking.* FROM u_boss_sinking WHERE acc_id = '$acc_id' AND YEAR(payment_due_date) = '$year_select' ORDER BY date_received";
    ...
    //Quit rent
    $qr_query = "SELECT * FROM u_boss_quitrent WHERE acc_id = '$acc_id' AND YEAR(date_received) = '$year_select' ORDER BY date_received";
    ...
    //Insurance 
    $ip_query = "SELECT * FROM u_boss_insurance WHERE acc_id = '$acc_id' AND YEAR(date_from) = '$year_select' ORDER BY date_from";
	...
	//Cukai Kadaran
    $ip_query = "SELECT * FROM u_boss_cukai WHERE acc_id = '$acc_id' AND YEAR(date_paid) = '$year_select' ORDER BY date_paid";
    $result_cukai = mysqli_query($conn_admin_db, $ip_query) or die(mysqli_error($conn_admin_db));
    $arr_data_cukai= [];
    while ($rows = mysqli_fetch_assoc($result_cukai)){
        $arr_data_cukai[] = $rows;
    }
	
	//Cukai Taksiran
    $ip_query = "SELECT * FROM u_boss_taksiran WHERE acc_id = '$acc_id' AND YEAR(payment_date) = '$year_select' ORDER BY payment_date";
    $result_taksiran = mysqli_query($conn_admin_db, $ip_query) or die(mysqli_error($conn_admin_db));
    $arr_data_taksiran= [];
    while ($rows = mysqli_fetch_assoc($result_taksiran)){
        $arr_data_taksiran[] = $rows;
    }
?>
                	...
                	<div class="col-md-12">
                        <div class="card" id="printableArea">
                            <div class="card-header">                            
                                <strong class="card-title"><a href="boss_payment.php">Boss Payment</a> > Account Details</strong>
                            </div>     
                            <div class="card-body">                                       
                                <div class="col-sm-12">
                            	...
                            	<div class="tabs">
                                    <ul class="tab-links">
                                        <li id="t1"><a href="#tab1" class="tab1a">Maintenance Fee</a></li>
                                        <li id="t2"><a href="#tab2" class="tab2a">Water Bill</a></li>
                                        <li id="t3"><a href="#tab3" class="tab3a">Sinking Fund</a></li>
                                        <li id="t4"><a href="#tab4" class="tab4a">Quit Rent</a></li>
                                        <li id="t5"><a href="#tab5" class="tab5a">Insurance</a></li> 
										<li id="t6"><a href="#tab6" class="tab6a">Cukai Kadaran</a></li>
										<li id="t7"><a href="#tab7" class="tab7a">Cukai Taksiran</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <div class="tab active" id="tab1">
                                            <table id="table-mfee" class="table table-striped table-bordered">                                               
                                            	...
                                            	<tr>
													...
													<td class="text-right"><?=number_format ($data['insurance'],2)?></td>
													<td class="text-right"><?=number_format ($data['mco'],2)?></td>
                                                    ...
                                                    <td class="text-center">
                                                    	<span onclick="window.open('add_maintenance_fee.php?id=<?=$acc_id?>&item_id=<?=$data['id']?>')"><i class="fa fa-edit"></i></span>
                                                    	<span id="<?=$data['id']?>" data-toggle="modal" data="u_bp_maintenance" class="delete_data" data-target="#deleteItem"><i class="fas fa-trash-alt"></i></span>
                                                    </td>                                         
                                                </tr>
                                            	<?php }?>
                                            	</tbody>  
                                        ...
                                        <div class="tab" id="tab2">                                            
                                        	...
                                        	<tr>
                                                ...
                                                <td class="text-center"><?=dateFormatRev($data['payment_date'])?></td> 
                                                <td class="text-center">
                                                	<span onclick="window.open('add_water_bill_record.php?id=<?=$acc_id?>&item_id=<?=$data['id']?>')"><i class="fa fa-edit"></i></span>
                                                	<span id="<?=$data['id']?>" data-toggle="modal" data="u_management_water_bill" class="delete_data" data-target="#deleteItem"><i class="fas fa-trash-alt"></i></span>
                                                </td>
                                        ...
                                        <div class="tab" id="tab3">                                        	
                                        	...
                                        	<tr>
												...
												<td class="text-left"><?=dateFormatRev($data['date_received'])?></td>
                                                <td class="text-center">
                                                	<span onclick="window.open('add_boss_sinking.php?id=<?=$acc_id?>&item_id=<?=$data['id']?>')"><i class="fa fa-edit"></i></span>
                                                	<span id="<?=$data['id']?>" data-toggle="modal" data="u_boss_sinking" class="delete_data" data-target="#deleteItem"><i class="fas fa-trash-alt"></i></span>
                                                </td>                                                                                                       
                                            </tr>
                                        	<?php }
                                        	}?>
                                        ...
                                        <div class="tab" id="tab4">                                            
                                        	...
                                        	<tr>
                                                ...
                                                <td class="text-center">
                                                	<span onclick="window.open('add_boss_quitrent.php?id=<?=$acc_id?>&item_id=<?=$data['id']?>')"><i class="fa fa-edit"></i></span>
                                                	<span id="<?=$data['id']?>" data-toggle="modal" data="u_boss_quitrent" class="delete_data" data-target="#deleteItem"><i class="fas fa-trash-alt"></i></span>
                                                </td>                                                                               
                                            </tr>
                                        	<?php }
                                        	}?>
                                    ...
                                    <div class="tab" id="tab5">                                        
                                    	...
                                    	<tr>
                                            ...
                                            <td class="text-center"><?=$data['or_no']?></td>    
                                            <td class="text-center">
                                            	<span onclick="window.open('add_boss_insurance.php?id=<?=$acc_id?>&item_id=<?=$data['id']?>')"><i class="fa fa-edit"></i></span>
                                            	<span id="<?=$data['id']?>" data-toggle="modal" data="u_boss_insurance" class="delete_data" data-target="#deleteItem"><i class="fas fa-trash-alt"></i></span>
                                            </td>                                                                                                                                             
                                        </tr>
                                    	<?php }
                                    	}?>
								...
								<div class="tab" id="tab6">                                        
                                        <table id="table-cukai" class="table table-striped table-bordered">                                                
                                        <thead>                                            
                                            <tr>
                                            	<th>Premium Date</th>
                                            	<th>No.Geran.</th>
                                    	...
                                    	<tbody>
                                    	<?php 
                                    	if(!empty($arr_data_cukai)){
                                    	    $total_ip = 0;
                                    	    foreach ($arr_data_cukai as $data){
                                    	        $total_ip += $data['payment'];
                                    	        ?>
                                    	<tr>
                                            <td class="text-left"><?=$data['date_from']."~".$data['date_to']?></td>
                                            <td class="text-left"><?=$data['no_geran']?></td>
											<td class="text-left"><?=$data['no_siri']?></td>
                                            <td class="text-right"><?=number_format($data['jenis_harta'],2)?></td>  
                                            <td class="text-center"><?=strtoupper($data['kadar_semasa'])?></td>                                          
                                            <td class="text-center"><?=$data['amount']?></td>                                                                                  
                                            <td class="text-center"><?=$data['date_paid']?></td>    
                                            <td class="text-center">
                                            	<span onclick="window.open('add_boss_cukai.php?id=<?=$acc_id?>&item_id=<?=$data['id']?>')"><i class="fa fa-edit"></i></span>
                                            	<span id="<?=$data['id']?>" data-toggle="modal" data="u_boss_cukai" class="delete_data" data-target="#deleteItem"><i class="fas fa-trash-alt"></i></span>
                                            </td>                                                                                                                                             
                                        </tr>
                                    	<?php }
                                    	}?>
								...
								<div class="tab" id="tab7">                                        
                                        <table id="table-taksiran" class="table table-striped table-bordered">                                                
                                        <thead>                                            
                                            <tr>
                                            	<th>Period</th>
                                            	<th>No.Lot</th>
                                    	...
                                    	<tbody>
                                    	<?php 
                                    	if(!empty($arr_data_taksiran)){
                                    	    $total_ip = 0;
                                    	    foreach ($arr_data_taksiran as $data){
                                    	        $total_ip += $data['payment'];
                                    	        ?>
                                    	<tr>
                                            <td class="text-left"><?=$data['date_from']."~".$data['date_to']?></td>
                                            <td class="text-left"><?=$data['no_lot']?></td>
											<td class="text-left"><?=$data['no_bill']?></td>
											<td class="text-left"><?=$data['quarter_rate']?></td>
                                            <td class="text-right"><?=number_format($data['payment'],2)?></td>  
                                            <td class="text-center"><?=strtoupper($data['payment_mode'])?></td>                                          
                                            ...
                                            <td class="text-center">
                                            	<span onclick="window.open('add_boss_taksiran.php?id=<?=$acc_id?>&item_id=<?=$data['id']?>')"><i class="fa fa-edit"></i></span>
                                            	<span id="<?=$data['id']?>" data-toggle="modal" data="u_boss_taksiran" class="delete_data" data-target="#deleteItem"><i class="fas fa-trash-alt"></i></span>
                                            </td>                                                                                                                                             
                                        </tr>
                                    	<?php }
                                    	}?>
                                    	...
                                    	<tfoot>
                                    	<?php if(!empty($arr_data_taksiran)){?>
                                    	<tr>
              ...
              "buttons": [
                {
                  ...
                  action: function(e, dt, node, config) {
                    //trigger the bootstrap modal
                      window.open('add_maintenance_fee.php?id=<?=$acc_id?>');
                  }
                }
              ],
              "dom": {
              ...
              "buttons": [
                {
                  ...
                  action: function(e, dt, node, config) {
                    //trigger the bootstrap modal
                      window.open('add_water_bill_record.php?id=<?=$acc_id?>');
                  }
                }
              ],
              "dom": {
              ...
              "buttons": [
                {
                  ...
                  action: function(e, dt, node, config) {
                    //trigger the bootstrap modal
                      window.open('add_boss_sinking.php?id=<?=$acc_id?>');
                  }
                }
              ],
              "dom": {
              ...
              "buttons": [
                {
                  ...
                  action: function(e, dt, node, config) {
                    //trigger the bootstrap modal
                      window.open('add_quitrent_record.php?id=<?=$acc_id?>');
                  }
                }
              ],
              "dom": {
              ...
              "buttons": [
                {
                  ...
                  action: function(e, dt, node, config) {
                    //trigger the bootstrap modal
                      window.open('add_boss_insurance.php?id=<?=$acc_id?>');
                  }
                }
              ],
              "dom": {
              ...
              "buttons": [
                {
                  ...
                  action: function(e, dt, node, config) {
                    //trigger the bootstrap modal
                      window.open('add_boss_cukai.php?id=<?=$acc_id?>');
                  }
                }
              ],
              "dom": {
              ...
              "buttons": [
                {
                  ...
                  action: function(e, dt, node, config) {
                    //trigger the bootstrap modal
                      window.open('add_boss_taksiran.php?id=<?=$acc_id?>');
                  }
                }
              ],
              "dom": {
