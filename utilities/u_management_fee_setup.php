                    ...
                    <div class="card" id="printableArea">
                       ...
                       <div class="form-group row col-sm-12">  
                            ...
                            <table id="item-data-table" class="table table-striped table-bordered">
                                ...
                                <?php 
                                    $sql_query = "SELECT * FROM u_management_account WHERE status ='1'"; 
                                    if(mysqli_num_rows(mysqli_query($conn_admin_db,$sql_query)) > 0){
                                        ...
                                        $sql_result = mysqli_query($conn_admin_db, $sql_query)or die(mysqli_error($conn_admin_db));
                                            while($row = mysqli_fetch_array($sql_result)){ 
                                                ...
                                                ?>
                                                <tr>
                                                    <td><a href="u_management_account_details.php?id=<?=$row['id']?>" target="_blank" style="color:blue;"><?=$row['reference_no']?></a></td>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="form-group row col-sm-12">
					...
					<div class="col-sm-6">
                            <label for="reference_no" class=" form-control-label"><small class="form-text text-muted">Reference No</small></label>
