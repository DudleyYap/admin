<?php
	...
	$query = "SELECT * FROM u_bp_maintenance WHERE id='$item_id'";
                        ...
                        <div class="card" id="printableArea">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row form-group col-sm-12">
                                    <div class="col-sm-6">
                                        <label for="invoice_no" class=" form-control-label"><small class="form-text text-muted">Bill No. <span class="color-red">*</span></small></label>
                                ...
                                <div class="row form-group col-sm-12">  
								  ...
								  <div class="row form-group col-sm-12">  
                                	<div class="col-sm-6">
                                        <label for="insurance" class=" form-control-label"><small class="form-text text-muted">Insurance/Quit Rent</small></label>
                                        <input type="text" id="insurance" name="insurance" value="<?=$insurance?>" class="form-control">
                                    </div>                                   	
                                    <div class="col-sm-6">
                                        <label for="mco" class=" form-control-label"><small class="form-text text-muted">CN(MCO)</small></label>
                                        <input type="text" id="mco" name="mco" value="<?=$mco?>" class="form-control">
                                    </div>        
                                </div> 
