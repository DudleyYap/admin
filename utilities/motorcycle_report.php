<?php
    ...
    $select_m = isset($_POST['select_motor']) ? $_POST['select_motor'] : "";
?>
                                ...
                                <form id="myform" enctype="multipart/form-data" method="post" action="">                	                   
                    	            <div class="form-group row col-sm-12">
                    	            	<div class="col-sm-3">
                                          ...
                                          <div class="col-sm-2">
                                			<label for="motor" class="form-control-label"><small class="form-text text-muted">Motorcycles</small></label>
                                    		<?php
                                                $select_motor = mysqli_query ( $conn_admin_db, "SELECT uam_id, upper(motor_name) FROM u_add_motorcycle ORDER BY motor_name ASC ");
                                                db_select ($select_motor, 'select_motor', $select_m,'submit()','All','form-control form-control-sm','');                        
                                            ?>
                                      	</div>  
    	  ...
    	  var table = $('#vehicle_schedule').DataTable({
              ...
              "ajax":{
               ...
               "data" : function ( data ){
						...
						data.action = 'display_motorcycle';
						data.select_company = '<?=$select_c?>';
                        data.select_motor = '<?=$select_m?>';
                   }
              },
              "columnDefs": [
            	  {
