<?php 
    ...
    $query = "SELECT * FROM u_se_account WHERE u_se_account.id = '$id'";
    ...
    $details_query = "SELECT u_se_bill.id, MONTH(date_end) AS month_to_name, meter_reading_from, meter_reading_to, 
            total_usage, current_usage, kwtbb, surcaj, other_charge,adjustment,date_start, date_end,
            amount,date_received, mco, cheque_no,date_paid FROM u_se_bill WHERE acc_id = '$acc_id' AND YEAR(date_end) = '$year_select'ORDER BY month_to_name ASC";
                	...
                	<div class="col-md-12">
                        <div class="card" id="printableArea">
                            <div class="card-header">                            
                                <strong class="card-title"><a href="sabah_electric_setup.php">Sabah Electric</a> > Account Details</strong>
                            </div>     
                            <div class="card-body">                                       
                                <div style="font-weight: bold;">
                                    ...
                                    <div class="col-sm-12">
                                    	<label class=" form-control-label">Cagaran : RM <?=$se_cagaran?></label>                                    	
                                    </div>
                                    <div class="col-sm-12">
                                    	<label class=" form-control-label">Tarif : <?=$tariff?></label>                                    	
                                    </div>   
                                </div>                                                                 
                            	<hr>
...
//                                         $amount += $data['amount'];
                                    ...
                                    <tr>
                                        ...
                                        <td><?=number_format($data['surcaj'],2)?></td>
        ...
        <div class="modal fade" id="addItem">
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row col-sm-12">
                        <div class="col-sm-6">
                            <label for="date_paid" class=" form-control-label"><small class="form-text text-muted">Date Paid</small></label>                                            
                            <div class="input-group">
                                <input id="date_paid" name="date_paid" class="form-control" autocomplete="off">
                                <div class="input-group-addon"><i class="fas fa-calendar-alt"></i></div>
                            </div>  
                        </div>       
                        <div class="col-sm-6">
                            ...
                            <div class="input-group">
                                <input id="date_received" name="date_received" class="form-control" autocomplete="off">
                                <div class="input-group-addon"><i class="fas fa-calendar-alt"></i></div>
                            </div>  
                        </div>
                    </div>                   
                    ...
                    <div class="row form-group col-sm-12">      
                        <div class="col-sm-4">
                         ...
                         <div class="col-sm-4">
                            <label for="surcaj" class=" form-control-label"><small class="form-text text-muted">Surcaj (RM)</small></label>
                            <input type="text" id="surcaj" name="surcaj" class="form-control" value="0">
                        </div>        
                        <div class="col-sm-4">
                            <label for="mco" class=" form-control-label"><small class="form-text text-muted">MCO 2%</small></label>
                            <input type="text" id="mco" name="mco" class="form-control" value="0">
                        </div>
                    </div>                    
                    <div class="row form-group col-sm-12">                                     	                       
                        <div class="col-sm-4">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row col-sm-12">
                        <div class="col-sm-6">
                            ...
                            <div class="input-group">
                                <input id="date_paid_edit" name="date_paid_edit" class="form-control" autocomplete="off">
                                <div class="input-group-addon"><i class="fas fa-calendar-alt"></i></div>
                            </div>  
                        </div>       
                        <div class="col-sm-6">
                            <label for="date_received_edit" class="form-control-label"><small class="form-text text-muted">Date Received</small></label>                                            
                            <div class="input-group">
                                <input id="date_received_edit" name="date_received_edit" class="form-control" autocomplete="off">
                                <div class="input-group-addon"><i class="fas fa-calendar-alt"></i></div>
                            </div>  
                        </div>
                    </div>                   
                    ...
                    <div class="row form-group col-sm-12">      
                        <div class="col-sm-4">
                         ...
                         <div class="col-sm-4">
                            <label for="surcaj" class=" form-control-label"><small class="form-text text-muted">Surcaj(RM)</small></label>
                            <input type="text" id="surcaj_edit" name="surcaj_edit" class="form-control" value="0">
                        </div>        
                        <div class="col-sm-4">
                            <label for="mco" class=" form-control-label"><small class="form-text text-muted">MCO 2%</small></label>
                            <input type="text" id="mco_edit" name="mco_edit" class="form-control" value="0">
                        </div>
                    </div>                    
                    <div class="row form-group col-sm-12">                                     	                       
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <label for="other_charge" class=" form-control-label"><small class="form-text text-muted">Other Charges (RM)</small></label>
                            <input type="text" id="other_charge_edit" name="other_charge_edit" class="form-control" value="0">
                        </div>
                        <div class="col-sm-4" id="cheque_no">
                        <label for="cheque_no" class=" form-control-label"><small class="form-text text-muted">Cheque No.</small></label>
...
//             }                                          
                 ...
                 $.ajax({  
                      url:"sabah.electric.setup.ajax.php",  
                      method:"POST",  
        ...
        $(document).on('click', '.edit_data', function(){
        	...
        	$.ajax({
        			...
        			success:function(data){ 
                        ...
                        $('#date_paid_edit').val(dateFormat(data.date_paid));      
                        $('#date_received_edit').val(dateFormat(data.date_received)); 
                        ...
                        $('#surcaj_edit').val(data.surcaj);      
                        $('#mco_edit').val(data.mco);          
