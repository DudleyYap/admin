<?php 
    ...
    $query = "SELECT * FROM u_jans_account WHERE u_jans_account.id = '$id'";
    ...
    $details_query = "SELECT u_jans_bill.id, MONTH(date_end) AS month_name, meter_reading_from, meter_reading_to, 
            ...
            FROM u_jans_bill WHERE acc_id = '$jabatan_air_acc_id' AND YEAR(date_end) = '$year_select' ORDER BY month_name ASC";
                	...
                	<div class="col-md-12">
                        <div class="card" id="printableArea">
                            <div class="card-header">                            
                                <strong class="card-title"><a href="jans_setup.php">Jabatan Air</a> > Account Details</strong>
                            </div>     
                            <div class="card-body">                                       
