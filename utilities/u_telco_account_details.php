<?php 
    ...
    $query = "SELECT * FROM u_telco_account WHERE u_telco_account.id = '$id'";
    ...
    $details_query = "SELECT MONTHNAME(DATE) AS month_name, amount_rm FROM u_telco_bill WHERE telco_acc_id = '$telco_acc_id' AND YEAR(date) = '$year_select'";
            	...
            	<div class="col-md-12">
                    <div class="card" id="printableArea">
                        <div class="card-header">                            
                            <strong class="card-title"><a href="u_telco_setup.php">Telco</a> > Account Details</strong>
                        </div>     
                        <div class="card-body">
