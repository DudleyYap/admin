                        ...
                        <div class="card" id="printableArea">
                           ...
                           <div class="card-body">                         
                                ...
                                <table id="item-data-table" class="table table-striped table-bordered">
                                    ...
                                    <?php 
                                        $sql_query = "SELECT * FROM u_telekom_account WHERE status ='1'"; 
                                        if(mysqli_num_rows(mysqli_query($conn_admin_db,$sql_query)) > 0){
                                            ...
                                            $sql_result = mysqli_query($conn_admin_db, $sql_query)or die(mysqli_error($conn_admin_db));
                                                while($row = mysqli_fetch_array($sql_result)){ 
                                                    ...
                                                    ?>
                                                    <tr>
                                                    	<td><a href="u_telekom_account_details.php?id=<?=$row['id']?>" target="_blank" style="color:blue;"><?=$row['account_no']?></a></td>                                                        
                                                        <td><?=$comp_name?></td>
                                                        <td><?=$row['owner']?></td>
                                                        <td><?=$row['location']?></td>                                                        
                                                        <td>
        ...
        <div class="modal fade" id="addItem" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row col-sm-12">
                    	<div class="col-sm-6">
                            <label for="ref_no" class=" form-control-label"><small class="form-text text-muted">Account No.</small></label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" method="POST" action="" id="update_form">                        
                        ...
                        <div class="form-group row col-sm-12">
                        	<div class="col-sm-6">
                                <label for="ref_no_edit" class=" form-control-label"><small class="form-text text-muted">Account No.</small></label>
