<?php
	...
	$header_title = !empty($item_id) ? "Edit Sinking Fund" : "Add Sinking Fund";
	
	$query = "SELECT * FROM u_boss_sinking WHERE id='$item_id'";
...
<body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" id="printableArea">
                            ...
                            <form id="add_sinking_fund" role="form" action="" method="post">
                            ...
                            <input type="hidden" id="item_id" name="item_id" class="form-control">
                                <div class="card-body card-block">
                                    <div class="form-group row col-sm-12"> 
                                       	<div class="col-sm-4">
                                            <label for="date_received" class=" form-control-label"><small class="form-text text-muted">Date Received <span class="color-red">*</span></small></label>                                            
									...
									<div class="form-group row col-sm-12 date">										  
                                        <div class="col-sm-4">
                                            <label for="charged_amt" class=" form-control-label"><small class="form-text text-muted">Total (RM) <span class="color-red">*</span></small></label>                                            
                                            <div class="input-group">
    ...
    $(document).ready(function() {          
    	var acc_id = '<?=$acc_id?>';
    	var item_id = '<?=$item_id?>';
        $('#add_sinking_fund').on("submit", function(event){  
            event.preventDefault();  
            $('#acc_id').val(acc_id); 
			$('#item_id').val(item_id);
			var action = ( item_id !='' ) ? 'update_sinking_fund' : 'add_sinking_fund';
			
        	$.ajax({  
                url:"boss.record.ajax.php",  
                method:"POST",  
                data:{action:action, data : $('#add_sinking_fund').serialize()},  
        ...
        $('#date_received, #payment_due_date').datepicker({
            format: "dd-mm-yyyy",
            autoclose: true,
