...
function update_quit_rent_billing($data){
    ...
    $query = "UPDATE u_management_quit_rent SET
            inv_no = '$invoice_no',
...
function update_management_bill($data){
    ...
    if (!empty($data)) {
        ...
        $query = "UPDATE u_management_fee SET
...
function update_premium_insurance($data){
    ...
    $query = "UPDATE u_management_insurance SET            
            invoice_no = '$invoice_no',
            description = '$description',
            payment = '$charged_amt',
            payment_mode = '$payment_mode',
...
function add_premium_insurance($data){
    ...
    $query = "INSERT INTO u_management_insurance SET 
            acc_id = '$acc_id',
            invoice_no = '$invoice_no',
            description = '$description',
            payment = '$charged_amt',
...
function add_quit_rent_billing($data){
    ...
    $query = "INSERT INTO u_management_quit_rent SET
            acc_id = '$acc_id',
            inv_no = '$invoice_no',
            invoice_date = '".dateFormat($invoice_date)."',
            payment = '$charged_amt',
...
function add_late_interest_charge($data){
    ...
    $query = "INSERT INTO u_management_lic SET
            acc_id = '".$acc_id."',
...
function update_late_interest_charge($data){
    ...
    $query = "UPDATE u_management_lic SET
            bill_date = '".dateFormat($bill_date)."',
            inv_no = '$invoice_no',
            payment_due_date = '".dateFormat($payment_due_date)."',
            description = '$description',
...
function add_new_management($data){
    ...
    if (!empty($data)) {
        ...
        $query = "INSERT INTO u_management_fee SET acc_id = '$acc_id',
            description = '$description',
            payment_amount = '$payment',
            remark = '$remark',
            payment_mode = '$payment_mode',
