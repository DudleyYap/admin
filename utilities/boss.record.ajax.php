...
if( $action != "" ){
    switch ($action){
        ...
        case 'add_sinking_fund':
                add_sinking_fund($data);
            break;
        case 'update_sinking_fund':
            update_sinking_fund($data);
            break;
		...
		case 'add_cukai_kadaran':
                add_cukai_kadaran($data);
            break;            
        case 'update_cukai_kadaran':
            update_cukai_kadaran($data);
            break;
			
		case 'add_cukai_taksiran':
                add_cukai_taksiran($data);
            break;            
        case 'update_cukai_taksiran':
            update_cukai_taksiran($data);
            break;
...
function update_quit_rent_billing($data){
    ...
    $query = "UPDATE u_boss_quitrent SET
            inv_no = '$invoice_no',
...
function update_management_bill($data){
    ...
    if (!empty($data)) {
        ...
        $query = "UPDATE u_bp_maintenance SET
...
function update_water_bill($data){
    ...
    if(!empty($data)){
        ...
        $query = "UPDATE u_management_water_bill SET
...
function update_premium_insurance($data){
    ...
    $query = "UPDATE u_boss_insurance SET            
            invoice_no = '$invoice_no',
            description = '$description',
            payment = '$charged_amt',
            payment_mode = '$payment_mode',
...
function add_premium_insurance($data){
    ...
    $query = "INSERT INTO u_boss_insurance SET 
            acc_id = '$acc_id',
            invoice_no = '$invoice_no',
            description = '$description',
            payment = '$charged_amt',
...
function add_quit_rent_billing($data){
    ...
    $query = "INSERT INTO u_boss_quitrent SET
            acc_id = '$acc_id',
            inv_no = '$invoice_no',
            invoice_date = '".dateFormat($invoice_date)."',
            payment = '$charged_amt',
...
function add_sinking_fund($data){
    global $conn_admin_db;
    $param = array();
    parse_str($data, $param); //unserialize jquery string data
    $acc_id = $param['acc_id'];
    ...
    $query = "INSERT INTO u_boss_sinking SET
            acc_id = '".$acc_id."',
...
function update_sinking_fund($data){
    global $conn_admin_db;
    $param = array();
    parse_str($data, $param); //unserialize jquery string data
    $id = $param['item_id'];
    ...
    $query = "UPDATE u_boss_sinking SET
            date_received = '".dateFormat($date_received)."',
            inv_no = '$invoice_no',
            payment_due_date = '".dateFormat($payment_due_date)."',
            description = '$description',
...
function insert_billing_water($data){
    ...
    if(!empty($data)){
        ...
        $query = "INSERT INTO u_management_water_bill SET 
                acc_id = '".$acc_id."',
                date_from = '".dateFormat($from_date)."',
                date_to = '".dateFormat($to_date)."',
                invoice_no = '$invoice_no',
...
function add_new_management($data){
    ...
    if (!empty($data)) {
        ...
        $query = "INSERT INTO u_bp_maintenance SET acc_id = '$acc_id',
            description = '$description',
            payment_amount = '$payment',
            remark = '$remark',
            payment_mode = '$payment_mode',
...
function update_cukai_kadaran($data){
    global $conn_admin_db;
    $param = array();
    parse_str($data, $param); //unserialize jquery string data
    ...
    $date_from = $param['date_from'];
    $date_to = $param['date_to'];
    $no_geran = $param['no_geran'];
    $amount = $param['amount'];
    $jenis_harta = $param['jenis_harta'];
    $no_siri = $param['no_siri'];
    $date_paid = $param['date_paid'];
	$kadar_semasa =$param['kadar_semasa'];
    
    $query = "UPDATE u_boss_cukai SET            
            no_geran = '$no_geran',
            no_siri = '$no_siri',
            amount = '$amount',
            jenis_harta = '$jenis_harta',
			kadar_semasa = '$kadar_semasa',
...
function add_cukai_kadaran($data){
    global $conn_admin_db;
    $param = array();
    parse_str($data, $param); //unserialize jquery string data
    ...
    $query = "INSERT INTO u_boss_cukai SET 
            acc_id = '$acc_id',
            no_geran = '$no_geran',
            no_siri = '$no_siri',
            amount = '$amount',
...
function add_cukai_taksiran($data){
    global $conn_admin_db;
    $param = array();
    parse_str($data, $param); //unserialize jquery string data
    ...
    $date_to = $param['date_to'];
    $no_lot = $param['no_lot'];
    $no_bill = $param['no_bill'];
    $quarter_rate = $param['quarter_rate'];
    $payment = $param['payment'];
    $payment_mode = $param['payment_mode'];
	$payment_date =$param['payment_date'];
	$date_received =$param['date_received'];
    ...
    $query = "INSERT INTO u_boss_taksiran SET 
            acc_id = '$acc_id',
            no_lot = '$no_lot',
            no_bill = '$no_bill',
...
function update_cukai_taksiran($data){
    global $conn_admin_db;
    $param = array();
    parse_str($data, $param); //unserialize jquery string data
   ...
   $date_from = $param['date_from'];
    ...
    $query = "UPDATE u_boss_taksiran SET            
           no_lot = '$no_lot',
            no_bill = '$no_bill',
            quarter_rate = '$quarter_rate',
            payment = '$payment',
