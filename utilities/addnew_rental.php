                                ...
                                <div class="card-body card-block">
                                    <div class="form-group row col-sm-12">
										...
										<div class="col-sm-4" id="">
											<label for="renter_name" class="control-label"><small class="form-text text-muted">Name<span style="color:red">*</span> </small></label>    
                                            <input type="text" id="renter_name" name="renter_name" placeholder="Enter here" class="form-control" required>
