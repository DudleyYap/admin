                            ...
                            <input type="hidden" id="item_id" name="item_id" class="form-control">
                                <div class="card-body card-block">
                                    <div class="form-group row col-sm-12"> 
                                        ...
                                        <div class="col-sm-4">
                                            <label for="maintenance_cost" class=" form-control-label"><small class="form-text text-muted">Maintenance Cost </small></label>                                            
                                            <div class="input-group">
                                                <input id="maintenance_cost" name="maintenance_cost" value="<?=$maintenance_cost?>" class="form-control" autocomplete="off" >                                                
                                            </div>  
                                        </div>  
                                         <div class="col-sm-4">
                                            <label for="electric_bill" class=" form-control-label"><small class="form-text text-muted">Electric Bill </small></label>                                            
                                            <div class="input-group">
