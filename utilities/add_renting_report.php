                        ...
                        <div class="card" id="printableArea">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group row col-sm-12">                    	
                                	<div class="col-sm-6">
                                        <label for="date_from" class=" form-control-label"><small class="form-text text-muted">From <span class="color-red">*</span></small></label>                                            
                                ...
                                <div class="row form-group col-sm-12">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="rental_deposit" name="rental_deposit" value="<?=$ur_rental_deposit?>" class="form-control" required>
                                    </div>
                                     <div class="col-sm-6">
                                        ...
                                        <input type="text" id="utility_deposit" name="utility_deposit" value="<?=$ur_utility_deposit?>" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row form-group col-sm-12">  
                                	<div class="col-sm-6">
                                        <label for="rental_monthly" class=" form-control-label"><small class="form-text text-muted">Rental/Monthly</small></label>
                                        <input type="text" id="rental_monthly" name="rental_monthly" value="<?=$ur_monthly_rental?>" class="form-control">
                                    </div>                                   	
                                    <div class="col-sm-6">
                                        <label for="rental_per_taxinv" class=" form-control-label"><small class="form-text text-muted">Rental as Per Tax Inv</small></label>
                                        <input type="text" id="rental_per_taxinv" name="rental_per_taxinv" value="<?=$ur_rental_taxinv?>" class="form-control">
                                    </div>        
                                </div>    
								
                                <div class="row form-group col-sm-12"> 
								<div class="col-sm-6">
                                        <label for="ur_gst" class=" form-control-label"><small class="form-text text-muted">GST (6%)</small></label>
                                        <input type="text" id="ur_gst" name="ur_gst" value="<?=$ur_gst?>" class="form-control">
                                    </div>  
                                	<div class="col-sm-6">
                                        <label for="remark" class=" form-control-label"><small class="form-text text-muted">Remark</small></label>
                                        <textarea id="remark" name="remark" class="form-control"><?=$ur_remark?></textarea>
                                    </div>
                                </div>
