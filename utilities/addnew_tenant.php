                            ...
                            <form id="" role="form" action="" method="post">
                                <div class="card-body card-block">
                                    <div class="form-group row col-sm-12">
                                        <div class="col-sm-4" id="tenant_name">
                                            ...
                                            <input type="text" id="tenant_name" name="tenant_name" placeholder="Name as per NRIC" class="form-control" required= "required">
                                        </div>     
										<!-- Aaron here : make sure that only alphabet and numerical is accepted in this section. Spacebar and special character cannot be entered -->
										 <div class="col-sm-4" id="tenant_icpass">
                                            <label for="tenant_icpass" class=" form-control-label"><small class="form-text text-muted">IC / Passport No<span style="color:red">*</span></small></label>
                                            <input type="text" id="tenant_icpass" name="tenant_icpass" placeholder="*NO Spacebar, dash or any special character" class="form-control" required= "required">
                                        </div>   
                                    </div> 
									<div class="form-group row col-sm-12">
                                        <div class="col-sm-4" id="tenant_fonno">
                                            <label for="tenant_fonno" class=" form-control-label"><small class="form-text text-muted">Contact No.<span style="color:red">*</span></small></label>
                                            <input type="text" id="tenant_fonno" name="tenant_fonno" placeholder="Contact No." class="form-control" required= "required">
                                        </div>     
                                    ...
                                    <div class="card-body">
                                        <button type="submitandrent" id="saveandrent" name="saveandrent" class="btn btn-success">Save & Add Rental</button>
