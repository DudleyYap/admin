...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card" id="printableArea">
                            ...
                            <hr>
                            <div class="card-body" >
                                <table id="maintenance_report" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                        	<th>No.</th>
                                            <th>Date</th>
	...
	<script type="text/javascript">
      $(document).ready(function() {
    	  var table = $('#maintenance_report').DataTable({
              "processing": true,
              "serverSide": true,
              "searching":false,
              "ajax":{
               ...
               "data" : function ( data ){
						...
						data.action = 'display_maintenance';
