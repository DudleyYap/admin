...
<body>
    ...
    <!-- Content -->
                    ...
                    <div class="col-md-12">
                        <div class="card" id="printableArea">
                            <div class="card-header">
                                <strong class="card-title">Sabah Electric SDN BHD</strong>
                            </div>     
                           <div class="card-body">                                                       
							<div class="form-group row col-sm-12">
								...
								<div>
									<span class="color-red"> ** To add new record of usage, please click the hyperlink in Account No. column</span>
								</div>								
							</div>
                                <table id="item-data-table" class="table table-striped table-bordered">
                                    ...
                                    <?php 
                                        $sql_query = "SELECT * FROM u_se_account WHERE status ='1'"; 
                                        if(mysqli_num_rows(mysqli_query($conn_admin_db,$sql_query)) > 0){
                                            ...
                                            $sql_result = mysqli_query($conn_admin_db, $sql_query)or die(mysqli_error($conn_admin_db));
                                                while($row = mysqli_fetch_array($sql_result)){ 
                                                    ...
                                                    ?>
                                                    <tr>
                                                    	<td><a href="sabah_electric_account_details.php?id=<?=$row['id']?>" target="_blank" style="color:blue;"><?=$row['account_no']?></a></td>                                                        
        ...
        <!-- Modal Add new Sabah Electric Account -->
        <div id="addItem" class="modal fade">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="form-group row col-sm-12">
                    	<div class="col-sm-6">
                            <label for="se_cagaran" class=" form-control-label"><small class="form-text text-muted">Cagaran</small></label>
                            <input type="text" id="se_cagaran" name="se_cagaran" class="form-control">
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row col-sm-12">
                    	<div class="col-sm-6">
                            <label for="reading_type" class=" form-control-label"><small class="form-text text-muted">Reading Type</small></label>
                            <input type="text" id="reading_type" name="reading_type" class="form-control">
                        </div>
                        <div class="col-sm-6">
                            <label for="premise_type" class=" form-control-label"><small class="form-text text-muted">Premise Type</small></label>
                            <input type="text" id="premise_type" name="premise_type" class="form-control">
                        </div>
                    </div> 
                    <div class="form-group row col-sm-12">
                    	<div class="col-sm-6">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" method="POST" action="" id="update_form">
                        ...
                        <div class="col-sm-6">
                            <label for="acc_no_edit" class=" form-control-label"><small class="form-text text-muted">Account No.<span class="color-red">*</span></small></label>
                        ...
                        <div class="form-group row col-sm-12">
                        	<div class="col-sm-6">
                                <label for="se_cagaran_edit" class=" form-control-label"><small class="form-text text-muted">Cagaran</small></label>
                                <input type="text" id="se_cagaran_edit" name="se_cagaran_edit" class="form-control">
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row col-sm-12">
                        	<div class="col-sm-6">
                                <label for="reading_type_edit" class=" form-control-label"><small class="form-text text-muted">Reading Type</small></label>
                                <input type="text" id="reading_type_edit" name="reading_type_edit" class="form-control">
                            </div>
                            <div class="col-sm-6">
                                <label for="premise_type_edit" class=" form-control-label"><small class="form-text text-muted">Premise Type</small></label>
                                <input type="text" id="premise_type_edit" name="premise_type_edit" class="form-control">
                            </div>
                        </div> 
                        <div class="form-group row col-sm-12">
                        	<div class="col-sm-6">
        ...
        $(document).on('click', '.edit_data', function(){
        	...
        	$.ajax({
        			...
        			success:function(data){  
                        ...
                        $('#se_cagaran_edit').val(data.cagaran);					
                        $('#tariff_edit').val(data.tarif);      
                        $('#reading_type_edit').val(data.reading_type);
                        $('#premise_type_edit').val(data.premise_type);					
