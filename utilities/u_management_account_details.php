<?php 
    ...
    $query = "SELECT * FROM u_management_account WHERE u_management_account.id = '$id'";
    ...
    //Management fee
    $details_query = "SELECT MONTHNAME(received_date) AS month_name,u_management_fee.* FROM u_management_fee WHERE acc_id = '$acc_id' AND YEAR(payment_date) = '$year_select' ORDER BY received_date";
    ...
    $li_query = "SELECT * FROM u_management_lic WHERE acc_id = '$acc_id' AND YEAR(bill_date) = '$year_select' ORDER BY bill_date";
    ...
    //Quit rent
    $qr_query = "SELECT * FROM u_management_quit_rent WHERE acc_id = '$acc_id' AND YEAR(date_received) = '$year_select' ORDER BY date_received";
    ...
    //Insurance Premium
    $ip_query = "SELECT * FROM u_management_insurance WHERE acc_id = '$acc_id' AND YEAR(date_from) = '$year_select' ORDER BY date_from";
                	...
                	<div class="col-md-12">
                        <div class="card" id="printableArea">
                            <div class="card-header">                            
                                <strong class="card-title"><a href="u_management_fee_setup.php">Management Fee</a> > Account Details</strong>
                            </div>     
                            <div class="card-body">                                       
                                <div class="col-sm-12">
                            	...
                            	<div class="tabs">
                                    ...
                                    <div class="tab-content">
                                            ...
                                            <table id="table-mfee" class="table table-striped table-bordered">                                               
                                            	...
                                            	<tr>
                                                    ...
                                                    <td class="text-center">
                                                    	<span onclick="window.open('add_management_fee_record.php?id=<?=$acc_id?>&item_id=<?=$data['id']?>')"><i class="fa fa-edit"></i></span>
                                                    	<span id="<?=$data['id']?>" data-toggle="modal" data="u_management_fee" class="delete_data" data-target="#deleteItem"><i class="fas fa-trash-alt"></i></span>
                                                    </td>                                         
                                                </tr>
                                            	<?php }?>
                                            	</tbody>  
                                        ...
                                        <div class="tab" id="tab3">                                        	
                                        	...
                                        	<tr>
                                                ...
                                                <td class="text-center"><?=$data['or_no']?></td> 
                                                <td class="text-center">
                                                	<span onclick="window.open('add_late_interest_charge_record.php?id=<?=$acc_id?>&item_id=<?=$data['id']?>')"><i class="fa fa-edit"></i></span>
                                                	<span id="<?=$data['id']?>" data-toggle="modal" data="u_management_lic" class="delete_data" data-target="#deleteItem"><i class="fas fa-trash-alt"></i></span>
                                                </td>                                                                                                       
                                            </tr>
                                        	<?php }
                                        	}?>
                                        ...
                                        <div class="tab" id="tab4">                                            
                                        	...
                                        	<tr>
                                                ...
                                                <td class="text-center">
                                                	<span onclick="window.open('add_quitrent_record.php?id=<?=$acc_id?>&item_id=<?=$data['id']?>')"><i class="fa fa-edit"></i></span>
                                                	<span id="<?=$data['id']?>" data-toggle="modal" data="u_management_quit_rent" class="delete_data" data-target="#deleteItem"><i class="fas fa-trash-alt"></i></span>
                                                </td>                                                                               
                                            </tr>
                                        	<?php }
                                        	}?>
                                    ...
                                    <div class="tab" id="tab5">                                        
                                    	...
                                    	<tr>
                                            ...
                                            <td class="text-center"><?=$data['or_no']?></td>    
                                            <td class="text-center">
                                            	<span onclick="window.open('add_insurance_premium.php?id=<?=$acc_id?>&item_id=<?=$data['id']?>')"><i class="fa fa-edit"></i></span>
                                            	<span id="<?=$data['id']?>" data-toggle="modal" data="u_management_insurance" class="delete_data" data-target="#deleteItem"><i class="fas fa-trash-alt"></i></span>
                                            </td>                                                                                                                                             
                                        </tr>
                                    	<?php }
                                    	}?>
              ...
              "buttons": [
                {
                  ...
                  action: function(e, dt, node, config) {
                    //trigger the bootstrap modal
                      window.open('add_management_fee_record.php?id=<?=$acc_id?>');
                  }
                }
              ],
              "dom": {
              ...
              "buttons": [
                {
                  ...
                  action: function(e, dt, node, config) {
                    //trigger the bootstrap modal
                      window.open('add_late_interest_charge_record.php?id=<?=$acc_id?>');
                  }
                }
              ],
              "dom": {
              ...
              "buttons": [
                {
                  ...
                  action: function(e, dt, node, config) {
                    //trigger the bootstrap modal
                      window.open('add_insurance_premium.php?id=<?=$acc_id?>');
                  }
                }
              ],
              "dom": {
