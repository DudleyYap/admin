                ...
                <div class="row" >
                    <div class="col-md-12">
                        ...
                        <div class="form-group col-sm-12 text-center">                      
                            <div><b>SETUP</b></div>
                            <div>Data entry for new property and rental.</div>
                        </div>
                        <div class="form-group col-sm-12 text-center">                      
                            <div><b>LISTING</b></div>
                        ...
                        <div class="form-group col-sm-12 text-center">                      
                            ...
                            <div class="row">
                                <div class="col-sm-2">&nbsp;</div>
                                <div class="col-sm-8">To view the table report of each data category such as property, management fee, Telco and Telekom by month, year or by company.</div>
                                <div class="col-sm-2">&nbsp;</div>
                            </div>
                        </div>
