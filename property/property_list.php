                                        ...
                                        if(mysqli_num_rows(mysqli_query($conn_admin_db,$sql_query)) > 0){
                                            ...
                                            $sql_result = mysqli_query($conn_admin_db, $sql_query)or die(mysqli_error($conn_admin_db));
                                                while($row = mysqli_fetch_array($sql_result)){ 
                                                    ...
                                                    $floorType = "<span><b>".$row['floor1']."<b></span><br><br>
                                                                         <span>".$row['floor2']."</span><br>";
                                                    $count++;
                                                    ?>
                                                    <tr>
                                                    <td><a href="property_image.php?id=<?=$row['up_id']?>" target="_blank" style="color:blue;"><?=$row['up_id']?></a></td>
                                                        ...
                                                        <td>
                                                        	<span id="<?=$row['up_id']?>" data-toggle="modal" class="edit_data" data-target="#editItem"><i class="menu-icon fa fa-edit"></i></span><br>
