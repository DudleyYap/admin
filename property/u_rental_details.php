<?php 
    ...
    $query = "SELECT * FROM u_renter
                                    INNER JOIN u_tenant ON u_tenant.id = u_renter.tenant_id
																		INNER JOIN u_property ON u_property.up_id = u_renter.address_id
    ...
    $renter_name = $row['tenant_name'];
    $tenant_remark = $row['ur_demise'];
    $address = $row['up_location'];

    
    
    //report renting
    $details_query = "SELECT * FROM u_renting_extend WHERE acc_id = '$acc_id'  ORDER BY date_from";
                ...
                <div class="row">
                	<div class="col-md-12">
                        <div class="card" id="printableArea">
                            ...
                            <div class="card-body">                                       
                                <div class="col-sm-12">
                                    <label class=" form-control-label"><small class="form-text text-muted">Tenant : <?=$renter_name?></small></label>                                        
                                </div>                                
                                <div class="col-sm-12">
                                	<label class=" form-control-label"><small class="form-text text-muted">Area: <?=$address?></small></label>                                    	
                                </div>
                                <div class="col-sm-12">
                            	...
                            	<div class="tabs">
                                    <ul class="tab-links">
                                        ...
                                        <li id="t2"><a href="#tab2" class="tab2a">Payment</a></li>
                                        ...
                                        <div class="tab active" id="tab1">
                                            <table id="table-report" class="table table-striped table-bordered">                                               
                                            	...
                                            	<tr>
                                                    ...
                                                    <td class="text-center"><?=$data['ure_remark']?></td>    
